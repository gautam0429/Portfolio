        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building scalable, type-safe web applications using MERN stack
                (MongoDB, Express.js, React.js, Node.js) and TypeScript, with a
                focus on backend optimization and real-time systems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>SOLVE</h3>
              <h4>System Design & Databases</h4>
              <p>
                Strong foundation in Data Structures, Algorithms, and
                Object-Oriented Programming, applied to designing robust
                database architectures and distributed systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Jest/Cypress</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
